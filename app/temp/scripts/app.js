      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            (0, _jquery2.default)(curr).addClass('reveal-item--visible');
          }, offset: that.osPct
        });
      });
    }
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    key: 'createHdrWaypoint',
    value: function createHdrWaypoint() {
      var that = this;
      new Waypoint({
    ...
    key: 'createPageSecWaypoints',
    value: function createPageSecWaypoints() {
      var that = this;
